...
public class PageNavigator {
	...
	public LoginPage getLoginPage(WebDriver driver) {
		...
		try {
			System.out.println("Before calling StartPage init.");
			startPage = PageFactory.initElements(driver, StartPage.class);
			System.out.println("StartPage succesfully initialized.");
	...
	public HomePage login(WebDriver driver) {
		...
		try {
			...
			System.out.println("did we get login page?");
	...
	public HomePage deleteRepository(WebDriver driver,
			RepositoryAbstractPage page) throws InterruptedException {
	...
	public StartPage deleteRepositiryAndLogout(WebDriver driver,
			String repName, RepositoryPage repositoryPage) throws InterruptedException {
